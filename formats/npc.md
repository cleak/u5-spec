...
Earlier revisions of this section called `Z[i]` an unsigned floor index, gave
the shipped alphabet as `0x00..0x07`, and told implementations not to read
`0x80..0xFF` as negative floor numbers; all of that is retracted.
