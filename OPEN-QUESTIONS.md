...
| Item | Where | Notes |
|---|---|---|
| Issue #238 reports a Sell panel that ignores arrows and Return, despite the original browser accepting navigation and Enter/Space selection. | `systems/shops.md` Section 8.1 | Obtain the starting save and asset identity, exact key events, and before/after frames of the highlighted row and conversation window. Exhaustive isolated dispatch and command-normalization checks confirm accepted commands but do not establish delivery through the live keyboard stack. |
