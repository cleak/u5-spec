...
| Issue #239 reports non-shrine terrain at Honesty and Humility, although fresh canonical asset decoding confirms tile 0x19 at all seven published surface shrine coordinates. | `catalogs/gazetteer.md` Section 7 | Recheck E-Enter, the exact pre-entry save, world plane and asset identities, including the sparse Britannia chunk mapping. M-Mix at those positions is expected and does not test shrine entry. |
