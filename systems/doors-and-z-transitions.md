...
- **Town-family trap-doors.** Trapdoor cells (`0x8C`) appear in several
  ...
  (`systems/town-mode.md` Section 10, under Underfoot effects - *corrected
  2026-09-12, issue #269*: this pointer named Section 3, which describes the
  ordinary trapdoor and not the scripted-death contract). That ring is also the only
