...
skiffs aboard in byte `+7`. Earlier revisions of this section and of the
section 2 family table gave the delivered hull as `100`; that value is
retracted. Buying a Skiff while that Frigate is still queued buying a Skiff while that Frigate is still queued
